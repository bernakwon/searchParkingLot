<template>
    <div class="main">
        ...
        <div>
            <div id="searchbox">
                <button type="button" @click="switchSearchNearFlag" :style="clickSearchNearCheck?'color:orange':'color:black'">가까운 곳 찾기</button>
                <!-- <input type="text" id="searchAddr" name="searchAddr" placeholder="주소 검색" v-model="addr">
                 ...
                 <input type="text" id="searchParkingName" name="searchParkingName" placeholder="주차장 검색"
                        v-model="parkingName">-->
                <input type="text" id="searchText" name="searchText" placeholder="주소, 전화번호, 주차장 검색"
                       v-model="searchText">
